...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button1.frame = CGRect(x: 100, y: 50, width: 200, height: 50)
        button2.frame = CGRect(x: 100, y: 100, width: 200, height: 50)
        button3.frame = CGRect(x: 100, y: 150, width: 200, height: 50)
        button4.frame = CGRect(x: 100, y: 200, width: 200, height: 50)
        ...
        label1.frame = CGRect(x: 100, y: 300, width: 200, height: 50)
    ...
    func rxInit() {
        ...
        button1.rx.tap
            .subscribe(onNext: { _ in
                interval.bind(to: self.label1.rx.text).disposed(by: self.intervalDisposeBag1)
        ...
        button3.rx.tap
            .subscribe(onNext: { _ in
                interval.bind(to: self.label2.rx.text).disposed(by: self.intervalDisposeBag2)
            }).disposed(by: disposeBag)
